...
public class ControlHandler {
	...
	public ControlHandler(Frame frame) {
		...
		clear.setMargin(new Insets(0,0,1,1));
	...
	public void position() {
		...
		showStepsCheck.setBounds(20, frame.getHeight()-90, 90, 20);
		diagonalCheck.setBounds(20, frame.getHeight()-76, 90, 20);
		trigCheck.setBounds(20, frame.getHeight()-62, 90, 20);
